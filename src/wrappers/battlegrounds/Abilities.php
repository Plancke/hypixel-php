...
class Abilities {
    ...
    protected static function initAbilities() {
        ...
        Abilities::addAbility(3, 0, new Ability("Fallen Souls", "Spiritguard", AbilityType::DAMAGE));
        Abilities::addAbility(3, 1, new Ability("Spirit Link", "Spiritguard", AbilityType::DAMAGE));
